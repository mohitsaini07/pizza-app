      ...
      <nav className="container py-5 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <Select>
            ...
            <SelectContent>
              <SelectItem value="light">Pizza Hut</SelectItem>
              <SelectItem value="dark">Biggies</SelectItem>
              <SelectItem value="system">Domino Pizza</SelectItem>
            </SelectContent>
          </Select>
        </div>
        <div className="flex items-center space-x-8">
          ...
          <div className="relative">
            ...
            <span className="absolute -top-4 -right-4 bg-primary h-6 w-6 text-white rounded-full text-sm flex items-center justify-center">
              5
            </span>
          </div>
          <div className="flex items-center space-x-2">
            <Phone />
            <span>+91 8279 2389 232</span>
          </div>
          <Button size={"sm"} className="hover:bg-rose-300">
            Logout
          </Button>
        </div>
      </nav>
